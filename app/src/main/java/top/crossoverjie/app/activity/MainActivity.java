...
import top.crossoverjie.app.activity.base.BaseActivity;
...
//        switch_city = (Button) findViewById(R.id.switch_city);
        cut_city = (TextView) findViewById(R.id.cut_city);
        ...
        cut_city.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                boolean isConnected = NetworkUtils.isConnected(MainActivity.this);
                if (isConnected){
                    Intent intent = new Intent(MainActivity.this,ChossCityActivity.class) ;
                    startActivityForResult(intent,1);
                }else{
                    DialogUitl.showDialog(MainActivity.this);
                }
            }
        });
    ...
    public void queryWeatherFromServer(final String addr){
        HttpUtil.sendRequest(addr, new HttpCallBackListener() {
            ...
            public void onFinish(String response) {
                ...
                DataUtility.saveToSharedPreferences(MainActivity.this,weather);
